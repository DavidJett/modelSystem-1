	...
	<div style="text-align: left;margin: 0 auto;width:100%;">
		...
		<div class="change-page">
			<?php
				...
				$preAddr = APP_URL . "Admin/taskView/$modelId/$partId/$deptId/$machineId/$workerId/".($now-1);
				$nxtAddr = APP_URL . "Admin/taskView/$modelId/$partId/$deptId/$machineId/$workerId/".($now+1);
				if($now>0){
...
<script src="<?php echo APP_URL ?>public/js/Admin/taskView.js"></script>
