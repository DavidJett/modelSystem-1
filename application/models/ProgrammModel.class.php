<?php
   class ProgrammModel extends Model
   {
	   ...
	   {   
	       $startTime=time();
		   $sql_1="select id from part_info where belongedModel='$modelId' and code='PROCODE' limit 1";
		   ...
		   $sql2="insert into part_task_list(name,belongedPart,userId,startTime) values('Programm','$partId','$userId','$startTime')";
