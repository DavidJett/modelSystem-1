...
var modelSystemRootTask = function(){
	table = $('#table');
...
var reloadTable = function(){
	...
	location.href = modelSystemURLHeader + 'Root/taskView/'+modelId+'/'+partId+'/'+deptId+'/'+machineId+'/'+workerId;
}
...
var save = function(e){
	...
	$.ajax({
		url: modelSystemURLHeader + '/Root/taskSave',
		type:'POST',
