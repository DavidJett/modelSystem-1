 ...
 var modelSystemRootDept = function(_right){
 	right = _right;
 	table = $('#table');
...
var save = function(e){
	...
	$.ajax({
		url: modelSystemURLHeader + '/Root/deptSave',
		type:'POST',
...
var remove = function(e){
	...
	if(confirm('确定要删除部门: '+name+"?")){
		$.ajax({
			url: modelSystemURLHeader + '/Root/deptRemove',
			type:'POST',
			data:{'id':id},
			success: function(data){
				data = data.trim();
...
var addDept = function(e){
	...
	checkButton.on('click', function(){
		...
		$.ajax({
			url: modelSystemURLHeader + '/Root/deptAdd',
			type:'POST',
